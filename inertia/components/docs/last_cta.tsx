          ...
          <div className="relative flex w-full max-w-[1000px] flex-col items-center justify-center overflow-hidden rounded-[2rem] border">
            ...
            <div className="absolute z-10">
              <div className="mx-auto size-24 rounded-[2rem] border bg-white/10 p-3 shadow-2xl backdrop-blur-md  lg:size-32">
                <img src="/images/logo.svg" alt="cta" />
              </div>
              ...
              <div className="absolute inset-0 -z-10 rounded-full  bg-white opacity-40 blur-xl " />
            </div>
            <div className="absolute inset-x-0 bottom-0 h-full bg-gradient-to-b from-transparent to-white to-70%" />
          </div>
        </div>
      </div>
    </section>
